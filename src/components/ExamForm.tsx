  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Prüfung erstellt", {
        description: `${formValues.subject.trim()} wurde erfolgreich angelegt.`,
      });

      onSuccess?.();
    } catch (err) {
      const errorMessage = err instanceof Error ? err.message : "Prüfung konnte nicht erstellt werden.";
